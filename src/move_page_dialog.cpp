...
MovePageDialog::MovePageDialog(frame_editor *app, bls::layout_box *box)
    : wxDialog(app, wxID_ANY, wxintl::translate("CHANGE_BOX_PAGE")), m_app(app), m_box(box)
{
    origpage = m_box->page;

    wxBoxSizer *sizer = new wxBoxSizer(wxVERTICAL);

    sizer->Add(new wxStaticText(this, wxID_ANY, wxintl::translate("BOX_PAGE_LABEL")), wxSizerFlags().Center().Border(wxALL, 5));
    ...
    okcancel->Add(new wxButton(this, wxID_OK, wxintl::translate("OK")), wxSizerFlags().Center().Border(wxALL, 5));
    okcancel->Add(new wxButton(this, wxID_CANCEL, wxintl::translate("Cancel")), wxSizerFlags().Center().Border(wxALL, 5));
